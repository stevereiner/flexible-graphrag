...
**User Guides (docs/):**
- [TIMEOUT-CONFIGURATIONS.md](../../ADVANCED/TIMEOUT-CONFIGURATIONS.md) - Timeout settings for Docling
- [LLM-EMBEDDING-CONFIG.md](../../LLM/LLM-EMBEDDING-CONFIG.md) - LLM and embedding configuration
- [ENVIRONMENT-CONFIGURATION.md](../../GETTING-STARTED/ENVIRONMENT-CONFIGURATION.md) - Full environment configuration
