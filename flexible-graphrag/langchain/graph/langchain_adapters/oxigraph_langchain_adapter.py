...
from .fuseki_langchain_adapter import _LazyRdfGraph
...
class OxigraphLangChainAdapter(RDFStoreAdapter):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # Use _LazyRdfGraph to avoid the immediate COUNT query in RdfGraph.__init__
        # that fails with a misleading error when the store is unreachable or empty.
        self.lc_graph = _LazyRdfGraph(self.query_endpoint)
